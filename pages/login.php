...
if (isset($_POST['kirish'])) {
	...
	foreach ($user_array as $key=>$user) {
		if ($_POST['login']==$user['login'] AND $_POST['password']==$user['parol']) {
		$_SESSION['login']=1;
        $_SESSION['user_id']=$key;
		header('Location: index.php');
	} else {
		echo 'Login yoki parol noto`gri!';
	}
	}
        ...
        <div class="row">
            ...
            <div class="colm-form">
                <div class="form-container">
                    ...
                    <button type="submit" name="kirish" class="btn-login">Login</button>

                	</form>

                    Don't have account? <a href="?page=reg">Sign up here</a>
                </div>
            </div>
        </div>
    </main>
